        ...
        },
        {
            ...
            content: (
                <div className="space-y-6">
                    ...
                    <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                        <li>
                            <strong>Título e descrição:</strong>
                            {' '}
                        ...
                        <li>
                            <strong>Datas:</strong>
                            {' '}
                            Início, fim e vencimento
                        </li>
                        <li>
                            <strong>Status:</strong>
                            {' '}
                            Rascunho, Ativo, Vencido, Cancelado, Encerrado
                        </li>
                    </ul>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="p-4 border border-border rounded-lg md:col-span-2">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Análise de contas por período de vencimento: A vencer, 1-30 dias, 31-60 dias, 61-90 dias,
                                {' '}
                                {'>'}
                                90 dias.
                            </p>
